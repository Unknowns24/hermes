...
type Example interface {
	...
	getExample() (h hermes.Hermes, email hermes.Email)
...
func (ed *SimpleExample) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
...
func (ed *WithTitleInsteadOfNameExample) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
		Brand: hermes.Branding{
			Name: "Hermes",
...
func (ed *WithGreetingDifferentThanDefault) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
		Brand: hermes.Branding{
			Name: "Hermes",
...
func (ed *WithSignatureDifferentThanDefault) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
		Brand: hermes.Branding{
			Name: "Hermes",
...
func (ed *WithInviteCode) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
		Brand: hermes.Branding{
			Name: "Hermes",
...
func (ed *WithFreeMarkdownContent) getExample() (hermes.Hermes, hermes.Email) {
	h := hermes.Hermes{
		Theme: ed.theme,
		Brand: hermes.Branding{
			Name: "Hermes",
...
`,
			...
			Dictionary: []hermes.Entry{
				{Key: "Dictionary that should not be displayed", Value: "Because of FreeMarkdown"},
			},
			Table: hermes.Table{
				Data: [][]hermes.Entry{
					{
...
func TestHermes_Default(t *testing.T) {
	h := hermes.Hermes{}
	h.SetDefaultHermesValues()
	email := hermes.Email{}
	email.SetDefaultEmailValues()

	assert.Equal(t, h.Theme, new(themes.Default))
	assert.Equal(t, h.Brand.Name, "Hermes")
	assert.Equal(t, h.Brand.Copyright, "Copyright © 2024 Hermes. All rights reserved.")
